function [fSiz,filters,c1OL,numSimpleFilters, lambda, sigma, G] = init_gabor(rot, RF_siz, Div)
...
% Our HMAX model first applied a battery of Gabor
% filters to the prey image, and the local and global
% background regions. The Gabor filters were applied at
% four angles and ten different scales, with Gamma = 1,
% phase = 2?, frequency of sinusoidal component = 4,
% minimum sigma = 2, maximum sigma = 20, increasing in
% steps of 2.
